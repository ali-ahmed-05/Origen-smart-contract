...
async function main() {
  ...
  nFT =await NFT.attach("0x226eB2436589ef764C3Ed02917597e5373444Bbd")
  

  Token = await ethers.getContractFactory("GCoin")
  token =await Token.attach("0x33564638659Ce03F2e3bd802b2D627Dc7f9cB57F")
